...
//  步骤7：shutdown() 已随关停编排下沉 app/session/shutdown.js，
...
{
  // shutdown 不再挂 Supervisor.prototype（原型挂载已消除）——
  ...
  // 关停路径先**中止**在途 npm 子进程（detached 者不死），
  ...
  p1.then(() => {
    ...
    // 外部关停且无在途会话退出 -> 落盘壳退出意图（9-18 谱系收口）
