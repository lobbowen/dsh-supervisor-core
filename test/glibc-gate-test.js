...
//
// 覆盖缺口（E-2 制度化登记，AUDIT-2026-09-19 第 4 批）：本文件的 R 系列只测
//   **脚本自身**；产物侧的执法点在 ci-core.sh（条件执行）。当前内核形态无 ELF 产物，
//   故「脚本对真实产物校验」这条链在本仓处于**待命**状态 —— 见下方 E-2 静态断言
//   （钉产线调用点真实存在）与 CROSS-PLATFORM-BUILD-AND-UPDATE.md §2.7。
