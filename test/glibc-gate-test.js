...
//
// ## 覆盖缺口（E-2 制度化登记）：本门禁绿 != 产物合格。
//   本文件测 check-glibc.sh **脚本自身**，并用下方 E-2 静态断言钉住 ci-core.sh 的
//   glibc 基座门禁步骤确实存在 —— 文档化门禁 != 实际执行。
//   剩余缺口如实登记：
