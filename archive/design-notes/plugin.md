...
> 范围：`src/domains/plugin/`（index.js 83 / ops.js 127 / jobs.js 72 / store.js 193 / market.js 279，合计 **1721 行**，2026-09-21 实测）。结构已落地。
> 依据：`design-notes/_MIGRATION-HISTORY.md` §4 + `DIRECTORY-STRUCTURE-DESIGN.md`（跨层 SSOT）
> + `design-notes/_MIGRATION-HISTORY.md`（R1–R7，**覆盖 BRIEF 相应表述**）。
