...
> **范围（本文负责）**：`src/domains/router/index.js` 的全部六类职责——落地前 763 行，落地后 **150 行（DF-1 ≤150 已达成）**（2026-09-21 实测）。结构已落地。
...
> **`design-notes/_MIGRATION-HISTORY.md`（R1–R5，覆盖 BRIEF 相应表述）**；并与并行设计
